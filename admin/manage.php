        ...
        <div class="right-col">
            <div class="card">
                ...
                <div style="margin-top: 20px;">
                    <a href="barcode_scan.php?mode=checkout&reservation_id=<?php echo $id; ?>" class="contact-btn" style="display: block; text-align: center; background: #10b981; border: none; text-decoration: none; padding: 12px; font-weight: bold;">
