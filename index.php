...
<header>
    ...
    <a href="tel:+22796124490" class="contact-btn">
        <i class="fas fa-phone-alt"></i> +227 96 12 44 90
    </a>
</header>
...
<section class="hero">
    <div class="hero-content">
        ...
        <p>Location de bâches, chaises, tables et toilettes mobiles de haute qualité pour mariages, baptêmes et conférences.</p>
        <a href="booking.php" class="contact-btn" style="display:inline-flex; padding: 15px 40px; font-size: 1.1rem;">Réservez Dès Maintenant</a>
    </div>
</section>
...
<div class="container testimonials-grid">
    <div class="testimonial-card" style="margin: 0;">
        ...
        <p style="font-style: italic; font-size: 1.1rem; color: #555;">"Service rapide, matériel impeccable ! Merci à toute l'équipe de Sam Event Location pour l'organisation parfaite."</p>
    ...
    <div class="testimonial-card" style="margin: 0;">
        ...
        <p style="font-style: italic; font-size: 1.1rem; color: #555;">"Les bâches sont de très bonne qualité et l'équipe est très professionnelle. Je recommande vivement pour tous vos mariages."</p>
