...
<div class="admin-container">
    ...
    <div class="main-content">
        ...
        <div class="grid-stats">
            <div class="stat-box">
                <div class="icon-circle" style="background: #e0e7ff; color: #4338ca;"><i class="fas fa-calendar-day"></i></div>
                <div>
                    <div style="font-size: 0.9rem; color: #666;">Réservations du jour</div>
                    <div style="font-size: 1.5rem; font-weight: 800; color: #1f2937;"><?php echo count($today_res); ?></div>
                </div>
            </div>
            <div class="stat-box">
                ...
                <div>
                    ...
                    <div style="font-size: 1.5rem; font-weight: 800; color: #1f2937;"><?php echo $pending_count; ?></div>
                </div>
            </div>
        </div>
            ...
            <?php else: ?>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #fafafa;">
                        <td style="padding: 12px;"><strong><?php echo htmlspecialchars($r['customer_name']); ?></strong></td>
                        ...
                        <td style="padding: 12px;"><span class="status-tag <?php echo $r['status']; ?>"><?php echo ucfirst($r['status']); ?></span></td>
                        <td style="padding: 12px;"><a href="manage.php?id=<?php echo $r['id']; ?>" style="color: var(--primary-blue);">Gérer</a></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
