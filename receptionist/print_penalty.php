...
<head>
    ...
    <style>
        ...
        @media (max-width: 600px) {
            ...
            .invoice-title h1 { font-size: 1.3rem; }
            .invoice-title p { font-size: 0.8rem; }
            .info-section { margin-bottom: 20px; }
            .info-block h3 { font-size: 0.7rem; margin-bottom: 5px; }
            .info-block p { font-size: 0.85rem; margin-bottom: 2px; }
            table th { padding: 6px; font-size: 0.7rem; }
            table td { padding: 8px 6px; font-size: 0.75rem; }
            .total-row td { padding: 10px 6px; font-size: 0.9rem; }
            .stamp-sold { font-size: 1.8rem; padding: 10px 20px; border-width: 4px; }
            .qr-code-img { width: 60px !important; height: 60px !important; }
            .qr-code-text { font-size: 0.5rem !important; }
            .collector-text { font-size: 0.8rem !important; }
            .reste-payer-text { font-size: 1rem !important; padding: 10px 6px !important; }
        }
        .print-btn {
            display: block;
            width: 200px;
    ...
    <?php else: ?>
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="3" class="text-right" style="padding: 15px 12px; font-weight: 900; font-size: 1.2rem;" class="reste-payer-text">RESTE À PAYER :</td>
                    <td class="text-right reste-payer-text" style="padding: 15px 12px; font-weight: 900; font-size: 1.2rem; <?php echo ($return_data['penalty_total'] - $return_data['penalty_paid'] <= 0) ? 'color: #166534;' : 'color: #ef4444;'; ?>"><?php echo number_format(max(0, $return_data['penalty_total'] - $return_data['penalty_paid']), 0, ',', ' '); ?> <?php echo getCurrency(); ?></td>
                </tr>
            </tbody>
        </table>
        ...
        <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-top: 20px;">
            <div style="text-align: left;">
                <img src="<?php echo $qr_code_url; ?>" alt="QR Code" class="qr-code-img" style="width: 80px; height: 80px; border: 2px solid #e2e8f0; padding: 5px; border-radius: 8px; background: white;">
                <div class="qr-code-text" style="font-size: 0.6rem; color: #64748b; margin-top: 5px; font-weight: bold; line-height: 1.2;">SCANNEZ POUR<br>VÉRIFIER</div>
            </div>
            
            <?php if ($return_data['penalty_paid'] > 0 && $collector_name): ?>
                <div class="collector-text" style="text-align: right; font-size: 1rem; color: #166534; padding-bottom: 5px;">
